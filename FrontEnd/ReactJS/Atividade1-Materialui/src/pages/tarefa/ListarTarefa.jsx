...
const initialRows = [
  createData(1, 'Estudar JavaScript', 'Praticar criação de programas simples com JavaScript', '01/01/2024', '13/06/2024', 'Concluindo', 'Recurso 1'),
  createData(2, 'Estudar ReactJS', 'Aprofundar os conhecimentos em ReactJS', '01/05/2024','10/12/2024', 'Em Andamento', 'Recurso 2'),
  createData(3, 'Editar', 'Editar programas para praticar', '2022-01-04', '10/12/2024', 'Em Andamento', 'Recurso 3'),
  createData(4, 'Olha o Peixe', 'Pêra Pêra Pêra', '01/05/2024', '10/12/2024', 'Em Andamento', 'Recurso 4'),
  createData(5, 'Peixada', 'Olha o peixe', '01/05/2024', '10/12/2024', 'Em Andamento', 'Recurso 5'),
  createData(6, 'Revisar bootstrap5', 'Revisar meus estudos em bootstrap 5 editando sass', '01/05/2024', '10/12/2024', 'Aguardando', 'Recurso 6'),
];
